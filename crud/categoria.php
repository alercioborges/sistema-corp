...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/style_categoria.css">
	<!--import dos icones-->
	...
	<div id="wrapper">		
		...
		<div id="content-wrapper">
			<div class="container-fluid">
				...
				<form name="dadosCategoria" id="dadosCategoria" action="conexao.php" method="POST">
					<div class="row">
						<div class="col-md-12 form">
							...
							<div class="input-group mb-3">
								...
								<select class="custom-select" name="categoria-pai" aria-required="true" required>									<option value="">SELECIONE</option>
								...
								<div class="form-group input-group  mb-3">						
									...
									<input type="text" name="nomeCategoria" maxlength="100" id="nomeCategoria" class="form-control" required autofocus />
								</div><!--end nome-->
								<label for="descricao">Descrição do curso</label>
								<div class="form-group input-group  mb-3">					
									<span class="input-group-text" id="basic-addon1"><i class="fas fa-file-alt"></i></span>
									<textarea required name="descricao" maxlength="254" id="descricao" class="form-control" rows="3">				</textarea><!--end testarea-->
								</div>
								<input type="hidden" name="acao" value="categoria" />
								<input class="btn btn-primary btn-block" type="submit" value="Criar categoria" />
							</div><!--end col-md-12-->
						</div><!--end row-->
					</form><!--end form-->
					<!--fim da customização -->
